...
public:
    ...
    static void updateTargetImgMode1(std::vector<cv::Mat> &imgButBAList, cv::Mat &targetImg);

    static void updteTargetImgMode2(std::vector<cv::Mat> &imgButBAList, cv::Mat &targetImg);
